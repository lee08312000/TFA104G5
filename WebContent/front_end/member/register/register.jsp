...
<body>
    ...
    <div class="updateform">
        <h2>會員基本資料填寫</h2>
        <form class="form-horizontal" method="post" action="<%= request.getContextPath() %>/member/MemberServlet">
            <div class="form-group">
                <!-- 姓名 -->
                <div class="control-label">
                    <input type="text" class="form-control" value="" name="name" placeholder="請輸入姓名" />
                </div>
            </div>
            <div class="form-group">
                <!-- 會員帳號 -->
                <div class="control-label">
                    <input type="text" class="form-control" value="" name="account" placeholder="請輸入會員帳號" />
                </div>
            </div>
            <div class="form-group">
                <!-- 輸入會員密碼 -->
                <div class="control-label">
                    <input type="text" class="form-control" value="" name="password" placeholder="請輸入會員密碼(大小寫有差別)" />
                </div>
            </div>
            <div class="form-group">
                <!-- 確認會員密碼 -->
            ...
            <div class="form-group">
                <!-- 地址 -->
                <div class="control-label">
                    <input type="text" class="form-control" value="" name="address" placeholder="請輸入地址" />
                </div>
            </div>
            <div class="form-group">
                <!-- email -->
                <div class="control-label">
                    <input type="text" class="form-control" value="" name="email" placeholder="請輸入Email" />
                </div>
            </div>
            <div class="form-group">
                <!-- 電話號碼 -->
                <div class="control-label">
                    <input type="text" class="form-control" value="" name="phone" placeholder="請輸入手機號碼" />
                </div>
            </div>
			<div>
            <%-- 錯誤表列 --%>
