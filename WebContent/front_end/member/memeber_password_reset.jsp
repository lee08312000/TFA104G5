        ...
        <form class="form-horizontal" method="post" action="<%= request.getContextPath() %>/member/MemberServlet">
            <div class="form-group">
                ...
                <div class="control-label">
                    <input type="text" class="form-control" value="" name="password" placeholder="請輸入新密碼(英文大小寫有差別)" />
                </div>
            </div>
            <div class="form-group">
                <!-- 確認新密碼 -->
                <div class="control-label">
                    <input type="text" class="form-control" value="" name="check" placeholder="請再次輸入新密碼(英文大小寫有差別)" />
                </div>
            </div>
            <div>
            <%-- 錯誤表列 --%>
