        ...
        <form class="form-horizontal" method="post" action="<%= request.getContextPath() %>/member/MemberServlet">
            <div class="form-group">
                ...
                <div class="control-label">
                    <input type="text" class="form-control" value="" name="account" placeholder="請輸入帳號" />
                </div>
            </div>
            <div class="form-group">
                <!-- 密碼 -->
            ...
            <button class="button" type="button" onclick="location.href = '<%=request.getContextPath()%>/front_end/member/register.jsp';">註冊</button>            
            <button class="button" type="button" onclick="location.href = '<%=request.getContextPath()%>/front_end/member/member_forgot_password.jsp';">忘記密碼</button>
