...
<body>
	...
	<div style="text-align: center;">
		<h2>
			1.確認商品 >> <span
				style="color: white; background-color: #dbb07c; border-radius: 20px; padding: 3px 10px;">2.資料填寫</span>
			>> 3.資料確認 >> 4.訂單成立
		</h2>
	</div>
	...
	<div class="shopping-cart" style="padding: 50px 30px 50px 30px;">
		...
		<form action="<%=request.getContextPath()%>/Cart/CartServlet"
			...
			<input type="hidden" name="action" value="inputReceiverInfo">
			<input type="submit" class="checkout" value="下一步">
		</form>

		<button type="button" class="checkout" style="margin-right: 30px;"
			onclick="location.href = '<%=request.getContextPath()%>/front_end/mall/shoppingCart01.jsp';">上一步</button>
