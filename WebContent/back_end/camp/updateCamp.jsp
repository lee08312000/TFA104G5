...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/back_end/css/updatecamp.css?v=002">
			...
			<table class="updatecamp">
				...
				<tr>
					<td><label>營地名稱:</label></td>
						...
						<input type="text" id="camp_id" name="camp_id" value="${campVO.campId}">
				...
				<tr>
					...
					<td><textarea name="campDiscription" cols="60" rows="10" >${campVO.campDiscription} </textarea></td>
				</tr>

				<tr>
					<td><label>營地租借規則:</label></td>
					<td><textarea name="campRule" cols="60" rows="10"> ${campVO.campRule}</textarea></td>
