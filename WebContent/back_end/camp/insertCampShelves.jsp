...
<%
	...
	if (request.getAttribute("campTagDetailList") != null) {
		...
		CampTagDetailService campTagDetailService = new CampTagDetailService();
		campTagDetailList = campTagDetailService.getAll();
	}
...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/back_end/css/insertcamp.css?v=001">
</head>
<body>
